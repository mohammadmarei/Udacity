...
})({"fgRvi":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 55248;
...
function createHeader(headerType, text, dataCy) {
    const header = document.createElement(headerType);
    header.textContent = text;
    header.setAttribute("data-cy", dataCy);
    return header;
}
function createToggleButton(text, element) {
...
function renderAboutPage() {
    ...
    const aboutImg = new URL(require("e6dc252feaf35e09")).href;
    const aboutImage = (0, _utilityRenderFunctionsJs.createImage)(aboutImg, "Child Studying");
    textContainer.append(heading, subHeading, aboutP);
    containerOuter.append(textContainer, aboutImage);
    main.append(containerOuter);
}

},{"./utilityRenderFunctions.js":"guzyD","e6dc252feaf35e09":"5RPqz","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"5RPqz":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("about.9f821191.png") + "?" + Date.now();
...
const renderHomePage = ()=>{
    ...
    const homeImg = new URL(require("d4a8e582fd435441")).href;
    const image = (0, _utilityRenderFunctionsJs.createImage)(homeImg, "Desk of laptops");
...
},{"./utilityRenderFunctions.js":"guzyD","d4a8e582fd435441":"cUH9T","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"cUH9T":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("home.496f474c.png") + "?" + Date.now();

},{}]},["fgRvi","a0t4e"], "a0t4e", "parcelRequireccf0", {}, "./", "/")

//# sourceMappingURL=Udacity.31b563d9.js.map
